...
static NSString *featureAId = @"com.quantum.towerfree.removeads";
static NSString *featureBId = @"com.quantum.towerfree.myfeatureB";
...
- (void) buyFeature:(NSString*) featureId
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"GlowBuilder" message:@"You are not authorized to purchase from AppStore"
