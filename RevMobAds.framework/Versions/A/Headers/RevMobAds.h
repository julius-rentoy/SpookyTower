...
+ (void) showFullscreenAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) showFullscreenAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate  __attribute__((deprecated));
+ (void) showFullscreenAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate withSpecificOrientations:(UIInterfaceOrientation)orientations, ... __attribute__((deprecated));
+ (void) showFullscreenAdWithAppID:(NSString *)appID withSpecificOrientations:(NSArray *)orientations withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) loadFullscreenAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) loadFullscreenAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) loadFullscreenAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate withSpecificOrientations:(UIInterfaceOrientation)orientations, ... __attribute__((deprecated));
+ (void) loadFullscreenAdWithAppID:(NSString *)appID withSpecificOrientations:(NSArray *)orientations withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) showLoadedFullscreenAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) showLoadedFullscreenAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (BOOL) isLoadedFullscreenAdWithAppID:(NSString *)appID __attribute__((deprecated));

+ (void) releaseLoadedFullscreenAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate withSpecificOrientations:(UIInterfaceOrientation)orientations, ... __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID withFrame:(CGRect)frame withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID withFrame:(CGRect)frame withDelegate:(NSObject<RevMobAdsDelegate> *)delegate withSpecificOrientations:(UIInterfaceOrientation)orientations, ... __attribute__((deprecated));
+ (void) showBannerAdWithAppID:(NSString *)appID withFrame:(CGRect)frame withSpecificOrientations:(NSArray *)orientations withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (void) deactivateBannerAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) openAdLinkWithAppID:(NSString *)appID __attribute__((deprecated));
+ (UIButton *) buttonAdWithAppID:(NSString *)appID __attribute__((deprecated));
+ (UIButton *) buttonAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
+ (UIButton *) buttonAdWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate withFrame:(CGRect)frame __attribute__((deprecated));
+ (void) showPopupWithAppID:(NSString *)appID __attribute__((deprecated));
+ (void) showPopupWithAppID:(NSString *)appID withDelegate:(NSObject<RevMobAdsDelegate> *)delegate __attribute__((deprecated));
