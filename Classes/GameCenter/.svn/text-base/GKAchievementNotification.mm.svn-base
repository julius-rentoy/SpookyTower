...
- (id)initWithAchievementDescription:(GKAchievementDescription *)achievement
{
    ...
    {
		// SMARTWAVE
//		if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeLeft)
//					self.transform = CGAffineTransformMakeRotation(M_PI/2);
//		else if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeRight)
//					self.transform = CGAffineTransformMakeRotation(M_PI/2 + M_PI);
    }
...
{
    CGRect frame = kGKAchievementFrameStart;
    self.title = title;
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        UIImageView *tBackground = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
...
//		self.frame = kGKAchievementFrameStartLandscapeRight;
	...
	// SMARTWAVE
//	if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeLeft)
//		    self.frame = kGKAchievementFrameEndLandscapeLeft;
//	else if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeRight)
...
- (void)animateOut
{
	...
	// SMARTWAVE
	if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeLeft)
		self.frame = kGKAchievementFrameStartLandscapeLeft;
	else if ([[CCDirector sharedDirector] deviceOrientation] == kCCDeviceOrientationLandscapeRight)
		self.frame = kGKAchievementFrameStartLandscapeRight;
